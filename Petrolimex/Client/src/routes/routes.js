...
const publicRoutes = [
    ...
    { path: config.routes.introduce, component: Introduce, layout: DefaultLayout },
    { path: config.routes.activity, component: Activity, layout: DefaultLayout },
    { path: config.routes.brand, component: Brand, layout: DefaultLayout },
    { path: config.routes.information, component: Information, layout: DefaultLayout },
